        ...
        <div className="wheelSummaryPro" style={{ paddingTop: 0 }}>
          ...
          <div className="wheelSummaryTiles">
            <div className="wheelSumTile">
              ...
              <div className="wheelSumVal">{spins}</div>
            </div>
        ...
        <>
          ...
          <div className="wheelSummaryPro" style={{ paddingTop: 12 }}>
            ...
            <div className="sg-muted" style={{ marginTop: 12 }}>
              ДЛЯ РАЗРАБОТЧИКА: Вычислять среднюю себестоимость призов из реальный и использовать в расчетах рекомендациях. Подсказка: если прибыль отрицательная — обычно лечится повышением цены спина или снижением “дорогих” призов (шанс/себестоимость).
            </div>
          </div>
        </>
      );
