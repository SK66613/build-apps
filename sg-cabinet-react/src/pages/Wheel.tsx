              ...
              <div key={code} className={'sgp-stockRow tone-' + tone}>
                <div className="sgp-stockCol sgp-stockCol--name">
                  <div className="sgp-stockNameRow">
                    {tracked && out && swz ? (
                      <span className="sgp-stockIco is-bad">!</span>
                    ) : tracked && low ? (
                      <span className="sgp-stockIco is-warn">!</span>
                    ) : !active ? (
                      <span className="sgp-stockIco is-off">—</span>
                    ) : (
                ...
                <div className="sgp-stockCol sgp-stockCol--status">{statusText}</div>
